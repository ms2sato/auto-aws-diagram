import { Resource, Connection } from './services/resource-collector';
import { SvgGenerator } from './services/svg-generator';
import { writeFileSync } from 'fs';

export function generateDemoSvg(outputPath = 'aws-architecture-demo.svg'): void {
  // デモ用のリソースを作成
  ...
  console.log(`Demo architecture diagram generated: ${outputPath}`);
}
